...
filepath = r"E:\projects\programming\py\pmx2pov\pmx\Sour\White.pmx"
folderpath = r"E:\projects\programming\py\pmx2pov\pmx\Sour"
...
code += pov_writer.PovWriter.write_texture(pmx, folderpath)
code += pov_writer.PovWriter.write_camera([0, 10, -22], [0, 10, 0])
